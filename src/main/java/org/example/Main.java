...
public class Main {
    public static void main(String[] args) {
        ...
        // Repositorios de Traza 1 (Empresas y Sucursales)
        ...
        // Repositorios de Traza 2 (Artículos)
        ...
        // Repositorio para la clase asociativa SucursalArticulo
        ...
        // ========== CONFIGURACIÓN TRAZA 1 (EMPRESAS Y SUCURSALES) ==========
        ...
        System.out.println("========================Datos traza 2==========================" +
                "");
        // ========== CONFIGURACIÓN TRAZA 2 (ARTÍCULOS) ==========
        // Crear categorías
        ...
        Categoria bebidas = Categoria.builder().denominacion("Bebidas").esInsumo(true).build();
        ...
        ArticuloInsumo sal = ArticuloInsumo.builder()
                ...
                .stockActual(100)
                .stockMinimo(10)
                .stockMaximo(200)//siempre tengo que tener un stock mínimo y un stock máximo
                .esParaElaborar(true)
                .unidadMedida(gramos)
                .categoria(insumos)
                .build();
        ...
        ArticuloManufacturado pizzaHawaina = ArticuloManufacturado.builder()
                ...
                .categoria(pizzas) //ya tengo las categorías creadas previamente
                .unidadMedida(kg)
        ...
        ArticuloManufacturado lomoCompleto = ArticuloManufacturado.builder()
                ...
                .unidadMedida(kg)
                .imagenes(new HashSet<>(Set.of(img4, img5, img6)))//ya tengo las imagenes 1,2,3
        ...
        articuloManufacturadoRepository.save(lomoCompleto);//así se guardan las entidades
        ...
        // ========== INTEGRACIÓN: STOCK POR SUCURSAL ==========
        System.out.println("============== INTEGRACIÓN TRAZA 1 + TRAZA 2 =================");
        System.out.println("--- Configurando Stock por Sucursal ---");

        // Stock para Sucursal 1
        SucursalArticulo stock1 = SucursalArticulo.builder()
                .sucursal(sucursal1)
        ...
        SucursalArticulo stock2 = SucursalArticulo.builder()
                .sucursal(sucursal1)
        ...
        SucursalArticulo stock3 = SucursalArticulo.builder()
                .sucursal(sucursal2)
                .articulo(lomoCompleto)
                .stock(40)
                .precioVenta(15.5)
        ...
        SucursalArticulo stock4 = SucursalArticulo.builder()
                .sucursal(sucursal2)
                .articulo(pizzaHawaina)
                .stock(25)
                .precioVenta(12.5)
        ...
        // GUARDAR stocks
        sucursalArticuloRepository.save(stock1);
        sucursalArticuloRepository.save(stock2);
        sucursalArticuloRepository.save(stock3);
        sucursalArticuloRepository.save(stock4);


        // 1. Precio de lomos en todas las sucursales
        System.out.println("\n1. Precios de 'Lomo' en todas las sucursales:");
        List<SucursalArticulo> todosLosStocks = sucursalArticuloRepository.findAll();
        List<SucursalArticulo> preciosLomo = todosLosStocks.stream()
                .filter(stock -> stock.getArticulo().getDenominacion().toLowerCase().contains("lomo"))
                .collect(Collectors.toList());

        preciosLomo.forEach(stock ->
                System.out.println("Sucursal: " + stock.getSucursal().getNombre() +
                        " - Precio: $" + stock.getPrecioVenta() +
                        " - Stock: " + stock.getStock())
        );

        // 2. Stock por sucursal específica
        System.out.println("\n2. Stock completo de Sucursal 1:");
        List<SucursalArticulo> stockSucursal1 = todosLosStocks.stream()
                .filter(stock -> stock.getSucursal().getId().equals(1L))
                .collect(Collectors.toList());

        stockSucursal1.forEach(stock ->
        ...
        // 3. Stock por empresa
        System.out.println("\n3. Stock de toda la Empresa 1:");
        List<SucursalArticulo> stockEmpresa = todosLosStocks.stream()
                .filter(stock -> stock.getSucursal().getEmpresa().getId().equals(1L))
                .collect(Collectors.toList());

        stockEmpresa.forEach(stock ->
                System.out.println("Sucursal: " + stock.getSucursal().getNombre() +
                        " - Artículo: " + stock.getArticulo().getDenominacion() +
                        " - Stock: " + stock.getStock())
        );
